// Theme Manager for Character Manager
class CharacterManagerThemeManager {
    constructor() {
        this.themes = {};
    ...
    async loadThemes() {
        try {
            ...
            console.error('Failed to load themes in Character Manager:', error);
    ...
    // Apply theme to Character Manager
    applyTheme(themeId) {
        ...
        console.log(`Character Manager theme applied: ${theme.name}`);
    }
    ...
    setupStorageListener() {
        window.addEventListener('storage', (e) => {
            if (e.key === this.SHARED_THEME_KEY && e.newValue !== e.oldValue) {
                console.log('Theme changed in main app, updating Character Manager...');
                this.loadSharedTheme();
            }
        });
    }
...
document.addEventListener('DOMContentLoaded', () => {
    window.characterManagerThemeManager = new CharacterManagerThemeManager();
});