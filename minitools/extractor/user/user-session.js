// User Session Management for Extractor - File-Based Avatar System
// Based on RP Archiver user session but adapted for Extractor
...
class UserSessionManager {
    ...
    async initializeUser() {
        console.log('Initializing extractor user session...');
    ...
    updateUserDisplay() {
        ...
        console.log(`Extractor active user: ${this.isGuest ? 'Guest' : this.currentUser.username}`);
    }
    ...
    setLastProject(projectName) {
        ...
        const storageKey = `extractorLastProject_${userContext.isGuest ? 'guest' : userContext.userId}`;
